...
exports.addTrip = async (req, res) => {
    ...
    try {
        const result = await pool.query(
            `INSERT INTO trips (user_id, review, stars, destination, trip_name, album, start_date, end_date, trip_genre) 
             VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *`,
            [user_id, review, stars, destination, trip_name, album, start_date, end_date, trip_genre]
        );
