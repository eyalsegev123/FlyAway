...
const SearchBox = ({ wishlist, setWishlist, originalWishlist }) => {
  ...
  const handleSearch = (event) => {
    ...
    // If search is empty, restore original wishlist
    if (!term.trim()) {
    ...
    const filtered = originalWishlist.filter(wish => 
      wish.wish_name.toLowerCase().includes(term)
    );
